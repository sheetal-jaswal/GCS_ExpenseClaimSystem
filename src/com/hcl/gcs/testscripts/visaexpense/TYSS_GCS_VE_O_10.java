...
/*
 * TestcaseId: TYSS_GCS_VE_O_10
 * Claim Type: Visa Expense
 * TestScript Name: TYSS_GCS_VE_O_10
 * Description: Verify the status of visa expenses claim after getting approved by RM,L3 Head,L1 Head ,ISG_Approver And ESA
 * */
public class TYSS_GCS_VE_O_10 extends BaseTest {

	@DataProviderFileRowFilter(file = "./data/GCSTestData.xlsx", sql = "Select * from VisaExpenses where  SlNo ='10'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description: Verify the status of visa expenses claim after getting approved by RM,L3 Head,L1 Head ,ISG_Approver And ESA")
	public synchronized void TC_TYSS_GCS_VE_O_10(String slNo, String employeeCode, String category, String description,
